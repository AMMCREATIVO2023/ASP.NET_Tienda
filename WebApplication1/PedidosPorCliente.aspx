<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdm.Master" AutoEventWireup="true" CodeBehind="PedidosPorCliente.aspx.cs" Inherits="WebApplication1.PedidosPorCliente" %>
...
<div>
    ...
    <asp:GridView ID="grdClientes" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IdCliente" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" PageSize="5" Width="50%" OnSelectedIndexChanged="grdClientes_SelectedIndexChanged1">
...
<asp:Label ID="lblResultado" runat="server"></asp:Label>
    <br />
<asp:Label ID="lblTotal" ForeColor="Black" runat="server"  Visible="False"></asp:Label>
<br />
    <br />
<br />
